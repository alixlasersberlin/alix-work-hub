...
const SepaMonatslauf = lazy(() => import("./pages/Finance/SepaMonatslauf"));
const RatenEndeLegal = lazy(() => import("./pages/Finance/RatenEndeLegal"));
const RatenPruefung = lazy(() => import("./pages/Finance/RatenPruefung"));
...
const BankZuordnung = lazy(() => import("./pages/Finance/BankZuordnung"));
...
const FinanceLohnbuchhaltung = lazy(() => import("./pages/Finance/Lohnbuchhaltung"));
...
const FinanceRechnungsnummern = lazy(() => import("./pages/Finance/Rechnungsnummern"));
const FinanceGobdKonflikte = lazy(() => import("./pages/Finance/GobdKonflikte"));
const FinanceGobdAudit = lazy(() => import("./pages/Finance/GobdAudit"));
const FinanceGobdRechnungsnummern = lazy(() => import("./pages/Finance/GobdRechnungsnummern"));
...
const AuftraegeGesucht = lazy(() => import("./pages/Verkauf/AuftraegeGesucht"));
const Backups = lazy(() => import("./pages/Backups"));
const Rollen = lazy(() => import("./pages/Rollen"));
const SystemMonitoring = lazy(() => import("./pages/SystemMonitoring"));
const LawyerList = lazy(() => import("./pages/LawyerList"));
const FinanceAnwaltsfaelle = lazy(() => import("./pages/Finance/Anwaltsfaelle"));
...
const GeraeteVerwaltung = lazy(() => import("./pages/GeraeteVerwaltung"));
...
const AlixSmartDeepSync = lazy(() => import("./pages/Kunden/AlixSmartDeepSync"));
...
const SocialKalender = lazy(() => import("./pages/Social/Kalender"));
...
const AlixConnectPlaybookAutomation = lazy(() => import("./pages/AlixConnect/PlaybookAutomation"));
const AlixConnectJourneyOrchestrator = lazy(() => import("./pages/AlixConnect/JourneyOrchestrator"));
const AlixConnectInsightsCockpit = lazy(() => import("./pages/AlixConnect/InsightsCockpit"));
const AlixConnectSlaEngine = lazy(() => import("./pages/AlixConnect/SlaEngine"));
const AlixConnectCopilotActions = lazy(() => import("./pages/AlixConnect/CopilotActions"));
const AlixConnectRevenueIntelligence = lazy(() => import("./pages/AlixConnect/RevenueIntelligence"));
const AlixConnectQualityCoaching = lazy(() => import("./pages/AlixConnect/QualityCoaching"));
const AlixConnectOmnichannelCampaigns = lazy(() => import("./pages/AlixConnect/OmnichannelCampaigns"));
...
const AlixConnectPredictiveEngagement = lazy(() => import("./pages/AlixConnect/PredictiveEngagement"));
const AlixConnectKnowledgeRag = lazy(() => import("./pages/AlixConnect/KnowledgeRag"));
const AlixConnectTranslationHub = lazy(() => import("./pages/AlixConnect/TranslationHub"));
const AlixConnectSentimentEmotion = lazy(() => import("./pages/AlixConnect/SentimentEmotion"));
const AlixConnectWorkflowStudio = lazy(() => import("./pages/AlixConnect/WorkflowStudio"));
const AlixConnectComplianceGovernance = lazy(() => import("./pages/AlixConnect/ComplianceGovernance"));
...
const AlixDocsPreview = lazy(() => import("./pages/AlixDocsPreview"));
const SignApiDocs = lazy(() => import("./pages/Admin/SignApiDocs"));
const AlixDocsReports = lazy(() => import("./pages/Admin/AlixDocsReports"));
const AlixDocsHeatmap = lazy(() => import("./pages/Admin/AlixDocsHeatmap"));
const AlixDocsMobile = lazy(() => import("./pages/mobile/AlixDocsMobile"));
const FreigabenMobile = lazy(() => import("./pages/mobile/FreigabenMobile"));
...
const PlmGeraeteakte = lazy(() => import("./pages/PLM/Geraeteakte"));
const PlmLieferantenbewertung = lazy(() => import("./pages/PLM/Lieferantenbewertung"));
const PlmQualitaetskennzahlen = lazy(() => import("./pages/PLM/Qualitaetskennzahlen"));
...
const BookVerkauf = lazy(() => import("./pages/ESC/public/Verkauf"));
...
const MedDashboard = lazy(() => import("./pages/MED/Dashboard"));
const MedArtikel = lazy(() => import("./pages/MED/Artikel"));
const MedBelege = lazy(() => import("./pages/MED/Belege"));
const MedBuchhaltung = lazy(() => import("./pages/MED/Buchhaltung"));
const MedCompliance = lazy(() => import("./pages/MED/Compliance"));
const MedEinstellungen = lazy(() => import("./pages/MED/Einstellungen"));
...
const CmrBetrieb = lazy(() => import("./pages/CMR/Betrieb"));
...
const FINANCE_ROLES = ['Admin', 'Super Admin', 'Buchhaltung Admin', 'Buchhaltung EU', 'Buchhaltung CH'];
...
function HomeRoute() {
  ...
  if (roles.includes('Österreich') && !(roles.includes('Super Admin') || roles.includes('Admin')) && !roles.includes('Admin')) {
    ...
    <Suspense fallback={<RouteFallback />}>
      <Routes>
        ...
        <Route element={<ProtectedRoute><ForceWelcomeGate><AppLayout /></ForceWelcomeGate></ProtectedRoute>}>
          ...
          <Route path="/auftraege/geliefert" element={<ProtectedRoute requiredRoles={ORDER_ROLES}><Orders deliveredOnly /></ProtectedRoute>} />
          ...
          <Route path="/cmr" element={<ProtectedRoute requiredRoles={['Super Admin','Admin','Geschäftsführung','CMR','CMR Viewer']}><CmrDashboard /></ProtectedRoute>} />
          <Route path="/cmr/artikel" element={<ProtectedRoute requiredRoles={['Super Admin','Admin','Geschäftsführung','CMR','CMR Viewer']}><CmrArtikel /></ProtectedRoute>} />
          <Route path="/cmr/dokumente" element={<ProtectedRoute requiredRoles={['Super Admin','Admin','Geschäftsführung','CMR','CMR Viewer']}><CmrDokumente /></ProtectedRoute>} />
          <Route path="/cmr/buchhaltung" element={<ProtectedRoute requiredRoles={['Super Admin','Admin','Geschäftsführung','CMR','CMR Viewer']}><CmrBuchhaltung /></ProtectedRoute>} />
          <Route path="/cmr/kunden" element={<ProtectedRoute requiredRoles={['Super Admin','Admin','Geschäftsführung','CMR','CMR Viewer']}><CmrKunden /></ProtectedRoute>} />
          <Route path="/cmr/projekte" element={<ProtectedRoute requiredRoles={['Super Admin','Admin','Geschäftsführung','CMR','CMR Viewer']}><CmrProjekte /></ProtectedRoute>} />
          <Route path="/cmr/abos" element={<ProtectedRoute requiredRoles={['Super Admin','Admin','Geschäftsführung','CMR','CMR Viewer']}><CmrAbos /></ProtectedRoute>} />
          <Route path="/cmr/mahnwesen" element={<ProtectedRoute requiredRoles={['Super Admin','Admin','Geschäftsführung','CMR','CMR Viewer']}><CmrMahnwesen /></ProtectedRoute>} />
          <Route path="/cmr/zeiten" element={<ProtectedRoute requiredRoles={['Super Admin','Admin','Geschäftsführung','CMR','CMR Viewer']}><CmrZeiten /></ProtectedRoute>} />
          ...
          <Route path="/admin/alixsmart-deepsync" element={<ProtectedRoute requiredRoles={['Super Admin','Admin']}><AlixSmartDeepSync /></ProtectedRoute>} />
          ...
          <Route path="/fibu-light/bank" element={<ProtectedRoute requiredRoles={[...FINANCE_ROLES, 'FIBU LIGHT']}><BankZuordnung /></ProtectedRoute>} />
          ...
          <Route path="/finance/ratenplan-sync" element={<ProtectedRoute requiredRoles={['Admin', 'Super Admin']}><FinanceRatenplanSync /></ProtectedRoute>} />
          ...
          <Route path="/finance/anlagenspiegel" element={<ProtectedRoute requiredRoles={FINANCE_ROLES}><FinanceAnlagenspiegel /></ProtectedRoute>} />
          <Route path="/finance/lohnbuchhaltung" element={<ProtectedRoute requiredRoles={FINANCE_ROLES}><FinanceLohnbuchhaltung /></ProtectedRoute>} />
          ...
          <Route path="/connect" element={<ProtectedRoute requiredRoles={['Super Admin']}><AlixConnectLayout /></ProtectedRoute>}>
            ...
            <Route path="playbooks" element={<ProtectedRoute requiredRoles={['Admin','Super Admin']}><AlixConnectPlaybookAutomation /></ProtectedRoute>} />
            <Route path="journey-orchestrator" element={<ProtectedRoute requiredRoles={['Admin','Super Admin']}><AlixConnectJourneyOrchestrator /></ProtectedRoute>} />
            <Route path="insights-cockpit" element={<ProtectedRoute requiredRoles={['Admin','Super Admin']}><AlixConnectInsightsCockpit /></ProtectedRoute>} />
            <Route path="sla-engine" element={<ProtectedRoute requiredRoles={['Admin','Super Admin']}><AlixConnectSlaEngine /></ProtectedRoute>} />
            <Route path="copilot-actions" element={<ProtectedRoute requiredRoles={['Admin','Super Admin']}><AlixConnectCopilotActions /></ProtectedRoute>} />
            <Route path="revenue-intelligence" element={<ProtectedRoute requiredRoles={['Admin','Super Admin']}><AlixConnectRevenueIntelligence /></ProtectedRoute>} />
            <Route path="quality-coaching" element={<ProtectedRoute requiredRoles={['Admin','Super Admin']}><AlixConnectQualityCoaching /></ProtectedRoute>} />
            <Route path="omnichannel-campaigns" element={<ProtectedRoute requiredRoles={['Admin','Super Admin']}><AlixConnectOmnichannelCampaigns /></ProtectedRoute>} />
            ...
            <Route path="predictive-engagement" element={<ProtectedRoute requiredRoles={['Admin','Super Admin']}><AlixConnectPredictiveEngagement /></ProtectedRoute>} />
            <Route path="knowledge-rag" element={<ProtectedRoute requiredRoles={['Admin','Super Admin']}><AlixConnectKnowledgeRag /></ProtectedRoute>} />
            <Route path="translation-hub" element={<ProtectedRoute requiredRoles={['Admin','Super Admin']}><AlixConnectTranslationHub /></ProtectedRoute>} />
            <Route path="sentiment-emotion" element={<ProtectedRoute requiredRoles={['Admin','Super Admin']}><AlixConnectSentimentEmotion /></ProtectedRoute>} />
            <Route path="workflow-studio" element={<ProtectedRoute requiredRoles={['Admin','Super Admin']}><AlixConnectWorkflowStudio /></ProtectedRoute>} />
            <Route path="compliance-governance" element={<ProtectedRoute requiredRoles={['Admin','Super Admin']}><AlixConnectComplianceGovernance /></ProtectedRoute>} />
          ...
          <Route path="/dokumente/lernregeln" element={<ProtectedRoute><AlixDocsLearnRules /></ProtectedRoute>} />
          <Route path="/dokumente/ai-suche" element={<ProtectedRoute requiredRoles={['Super Admin','Admin']}><AlixDocsAiSearch /></ProtectedRoute>} />
          <Route path="/dokumente/duplikate" element={<ProtectedRoute requiredRoles={['Super Admin','Admin']}><AlixDocsDuplicates /></ProtectedRoute>} />


          <Route path="/dokumente/dashboard" element={<ProtectedRoute><AlixDocsDashboardPage /></ProtectedRoute>} />
          <Route path="/alixdocs" element={<ProtectedRoute requiredRoles={['Super Admin','Admin']}><AlixDocsEnterpriseHub /></ProtectedRoute>} />
          <Route path="/alixdocs/aufgaben" element={<ProtectedRoute requiredRoles={['Super Admin','Admin']}><AlixDocsTasks /></ProtectedRoute>} />
          <Route path="/alixdocs/edit/:id" element={<ProtectedRoute requiredRoles={['Super Admin','Admin']}><AlixDocs2Editor /></ProtectedRoute>} />
          ...
          <Route path="/admin/alixdocs/heatmap" element={<ProtectedRoute requiredRoles={['Admin', 'Super Admin']}><AlixDocsHeatmap /></ProtectedRoute>} />
          <Route path="/m/alixdocs" element={<ProtectedRoute><AlixDocsMobile /></ProtectedRoute>} />
          <Route path="/m/freigaben" element={<ProtectedRoute><FreigabenMobile /></ProtectedRoute>} />
          ...
          <Route path="/produktion/geraeteakte" element={<ProtectedRoute><PlmGeraeteakte /></ProtectedRoute>} />
          <Route path="/produktion/lieferantenbewertung" element={<ProtectedRoute><PlmLieferantenbewertung /></ProtectedRoute>} />
          <Route path="/produktion/qualitaetskennzahlen" element={<ProtectedRoute><PlmQualitaetskennzahlen /></ProtectedRoute>} />
        ...
        {/* Mobile Mitarbeiteransicht – große Buttons, Adressen & Touren */}
        <Route path="/mobil" element={<ProtectedRoute><MobilLayout /></ProtectedRoute>}>
          <Route index element={<MobilHome />} />
          <Route path="adressen" element={<MobilAdressen />} />
          <Route path="touren" element={<MobilTouren />} />
