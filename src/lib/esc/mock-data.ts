...
export const MOCK_DEPARTMENTS: EscDepartment[] = [
  { id: 'sales',     name: 'Sales',            color: 'hsl(var(--primary))',   icon: 'TrendingUp',     active: true, publicBookable: true,  defaultDurationMinutes: 30, responsibleEmployeeIds: ['e1'], internalVisible: true,  externallyBookable: true,  description: 'Verkauf & Beratung' },
  { id: 'service',   name: 'Service',          color: 'hsl(var(--accent))',    icon: 'Wrench',         active: true, publicBookable: true,  defaultDurationMinutes: 60, responsibleEmployeeIds: ['e2'], internalVisible: true,  externallyBookable: true,  description: 'Serviceeinsätze & Reparatur' },
  { id: 'delivery',  name: 'Lieferung',        color: 'hsl(var(--secondary))', icon: 'Truck',          active: true, publicBookable: false, defaultDurationMinutes: 90, responsibleEmployeeIds: ['e3'], internalVisible: true,  externallyBookable: false, description: 'Auslieferungen & Einweisungen' },
  { id: 'media',     name: 'Mediapaket',       color: 'hsl(var(--primary))',   icon: 'Megaphone',      active: true, publicBookable: true,  defaultDurationMinutes: 45, responsibleEmployeeIds: ['e4'], internalVisible: true,  externallyBookable: true,  description: 'Mediapaket-Termine' },
  { id: 'training',  name: 'Schulung',         color: 'hsl(var(--accent))',    icon: 'GraduationCap',  active: true, publicBookable: true,  defaultDurationMinutes: 120, responsibleEmployeeIds: ['e5'], internalVisible: true, externallyBookable: true,  description: 'Allgemeine Schulungen' },
  { id: 'nisv-virt', name: 'NiSV Virtuell',    color: 'hsl(var(--primary))',   icon: 'MonitorPlay',    active: true, publicBookable: true,  defaultDurationMinutes: 60, responsibleEmployeeIds: ['e5'], internalVisible: true,  externallyBookable: true,  description: 'NiSV virtuelle Schulungen' },
  { id: 'nisv-pres', name: 'NiSV Präsenz',     color: 'hsl(var(--accent))',    icon: 'Users',          active: true, publicBookable: true,  defaultDurationMinutes: 240, responsibleEmployeeIds: ['e5'], internalVisible: true, externallyBookable: true,  description: 'NiSV Präsenzschulungen' },
  { id: 'marketing', name: 'Marketing',        color: 'hsl(var(--secondary))', icon: 'Sparkles',       active: true, publicBookable: false, defaultDurationMinutes: 60, responsibleEmployeeIds: [],     internalVisible: true,  externallyBookable: false, description: 'Marketing-Termine' },
  { id: 'tech',      name: 'Technik',          color: 'hsl(var(--primary))',   icon: 'Cog',            active: true, publicBookable: false, defaultDurationMinutes: 60, responsibleEmployeeIds: [],     internalVisible: true,  externallyBookable: false, description: 'Technik-Termine' },
  { id: 'finance',   name: 'Buchhaltung',      color: 'hsl(var(--secondary))', icon: 'Banknote',       active: true, publicBookable: false, defaultDurationMinutes: 30, responsibleEmployeeIds: [],     internalVisible: true,  externallyBookable: false, description: 'Buchhaltung' },
  { id: 'admin',     name: 'Administration',   color: 'hsl(var(--muted-foreground))', icon: 'Settings', active: true, publicBookable: false, defaultDurationMinutes: 30, responsibleEmployeeIds: [], internalVisible: true,  externallyBookable: false, description: 'Interne Administration' },
  { id: 'exec',      name: 'Geschäftsleitung', color: 'hsl(var(--primary))',   icon: 'Crown',          active: true, publicBookable: false, defaultDurationMinutes: 60, responsibleEmployeeIds: [],     internalVisible: true,  externallyBookable: false, description: 'Geschäftsleitungstermine' },
];
