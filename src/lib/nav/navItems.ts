...
export const navItems: NavItem[] = [
  ...
  {
    path: '/finance', label: 'BUCHHALTUNG', icon: Banknote, roles: ['Admin', 'Super Admin', 'Buchhaltung EU', 'Buchhaltung CH', 'Buchhaltung Admin', 'FIBU LIGHT'],
    children: [
      {
        ...
        children: [
          {
            ...
            children: [
              ...
              { path: '/finance/sepa-monatslauf', label: 'SEPA-Monatslauf', icon: Repeat, roles: ['Admin', 'Super Admin', 'Finance'] },
              { path: '/finance/sepa-monatslauf?tab=zahler', label: 'Aktive Zahler (SEPA)', icon: Repeat, roles: ['Admin', 'Super Admin', 'Finance'] },
              { path: '/finance/sepa-monatslauf?tab=laeufe', label: 'Monatsläufe', icon: Repeat, roles: ['Admin', 'Super Admin', 'Finance'] },
              { path: '/finance/sepa-monatslauf?tab=mandate', label: 'SEPA-Mandate', icon: Repeat, roles: ['Admin', 'Super Admin', 'Finance'] },
              { path: '/finance/sepa-monatslauf?tab=vorab', label: 'Pre-Notifications', icon: Repeat, roles: ['Admin', 'Super Admin', 'Finance'] },
              { path: '/finance/sepa-monatslauf?tab=ruecklast', label: 'Rücklastschriften (SEPA)', icon: Repeat, roles: ['Admin', 'Super Admin', 'Finance'] },
              { path: '/finance/sepa-monatslauf?tab=einstellungen', label: 'SEPA-Einstellungen', icon: Repeat, roles: ['Admin', 'Super Admin', 'Finance'] },
              { path: '/finance/sepa-monatslauf?tab=protokoll', label: 'SEPA-Protokoll', icon: Repeat, roles: ['Admin', 'Super Admin', 'Finance'] },
      ...
      },
      {
        ...
        children: [
          ...
          { path: '/finance/rechnungsnummern', label: 'Rechnungsnummern', icon: Lock, roles: ['Admin', 'Super Admin', 'Buchhaltung Admin', 'Buchhaltung EU', 'Buchhaltung CH'] },
          { path: '/finance/gobd/konflikte', label: 'GoBD · Synchronisationskonflikte', icon: Lock, roles: ['Admin', 'Super Admin', 'Buchhaltung Admin', 'Buchhaltung EU', 'Buchhaltung CH'] },
          { path: '/finance/gobd/audit', label: 'GoBD · Audit-Protokoll', icon: Lock, roles: ['Admin', 'Super Admin', 'Buchhaltung Admin', 'Buchhaltung EU', 'Buchhaltung CH'] },
...

  {
    ...
    children: [
      ...
      // 6b) MAILCENTER
      {
        path: '/mailcenter', label: 'MAILCENTER', icon: Mail, roles: ['Super Admin', 'Admin'],
        children: [
          { path: '/mailcenter', label: 'Dashboard', icon: LayoutDashboard, roles: null },
          { path: '/mailcenter/schreiben', label: 'E-Mail schreiben', icon: PenSquare, roles: null },
          ...
          { path: '/mailcenter/domains', label: 'Domains & Zustellbarkeit', icon: Globe, roles: null },
          ...
          { path: '/mailcenter/versandnachweise', label: 'Versandnachweise', icon: MailCheck, roles: null },
          { path: '/mailcenter/dokumente-vorlagen', label: 'Dokumenten-Vorlagen', icon: FileCheck2, roles: null },
          { path: '/mailcenter/dokumente-automationen', label: 'Dokumenten-Automationen', icon: Workflow, roles: null },
          { path: '/mailcenter/telefonnotizen', label: 'Telefonnotizen', icon: Phone, roles: null },
          { path: '/mailcenter/gespraechsprotokolle', label: 'Gesprächsprotokolle', icon: PhoneCall, roles: null },
          { path: '/mailcenter/aufgaben', label: 'Aufgaben', icon: CheckSquare, roles: null },
          { path: '/mailcenter/wiedervorlagen', label: 'Wiedervorlagen', icon: CalendarClock, roles: null },
          { path: '/mailcenter/telefonie', label: 'Telefonie', icon: PhoneCall, roles: null },
          { path: '/mailcenter/spam', label: 'Spam & Filter', icon: ShieldAlert, roles: null },
          { path: '/mailcenter/import', label: 'Import', icon: Upload, roles: null },
          { path: '/mailcenter/export', label: 'Export', icon: FileDown, roles: null },
          { path: '/mailcenter/backup', label: 'Backup', icon: Database, roles: null },
          { path: '/mailcenter/qualitaetssicherung', label: 'Qualitätssicherung', icon: ClipboardCheck, roles: null },
          { path: '/mailcenter/schulungscenter', label: 'Schulungscenter', icon: GraduationCap, roles: null },
          { path: '/mailcenter/testcenter', label: 'Testcenter', icon: TestTube2, roles: ['Super Admin'] },
          { path: '/mailcenter/systemvalidierung', label: 'Systemvalidierung', icon: BadgeCheck, roles: ['Super Admin'] },
          { path: '/mailcenter/produktivfreigabe', label: 'Produktivfreigabe', icon: Rocket, roles: ['Super Admin'] },
          { path: '/mailcenter/systemstatus', label: 'Systemstatus', icon: HeartPulse, roles: ['Super Admin'] },
          { path: '/mailcenter/audit-log', label: 'Audit-Log', icon: ScrollText, roles: ['Super Admin'] },
          { path: '/mailcenter/fehlerprotokoll', label: 'Fehlerprotokoll', icon: AlertOctagon, roles: ['Super Admin'] },
          { path: '/mailcenter/berechtigungen', label: 'Berechtigungen', icon: Shield, roles: ['Super Admin'] },
          { path: '/mailcenter/einstellungen', label: 'Einstellungen', icon: Settings, roles: ['Super Admin'] },
          { path: '/mailcenter/executive', label: 'Executive Cockpit', icon: LineChart, roles: ['Super Admin'] },
        ],
      },
