...
export async function sendCustomerShippingNotice(
  ...
  templateKey: 'customer_warehouse_received' | 'customer_shipping_notice' | 'customer_in_transit' | 'customer_in_production' | 'customer_warehouse_prepared' = 'customer_warehouse_received',
