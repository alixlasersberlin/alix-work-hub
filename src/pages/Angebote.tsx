                          ...
                          if (hasOrder) {
                            return (
                              <CheckCircle2
                                ...
                                aria-label="Auftrag zu diesem Angebot vorhanden"
                              />
                            );
                          }
                          if (hasCustomerOrder) {
                            return (
                              <CheckCircle2
                                className="h-4 w-4 text-sky-400/70 shrink-0"
                                aria-label="Kein Auftrag zu diesem Angebot – Kunde hat andere Aufträge"
                              />
                            );
                          }
