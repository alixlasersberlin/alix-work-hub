    ...
    <div className="p-4 md:p-6 space-y-4 ph-editor">
      ...
      <style>{`
        @media print {
          ...
          html, body { background: #fff; height: auto !important; min-height: 0 !important; max-height: none !important; overflow: visible !important; }
          .ph-editor > .print\\:hidden,
          .ph-editor > input { display: none !important; }
          .ph-print-root {
            display: block !important; position: static !important;
            width: 100% !important; height: auto !important; min-height: 0 !important;
            max-height: none !important; overflow: visible !important;
          }
          #root, #root > div, #root > div > div, main, .scroll-touch, .ph-editor, [data-radix-scroll-area-viewport] {
          ...
          .ph-cat-page {
            ...
            min-height: ${settings.pdf?.orientation === 'landscape' ? '210mm' : '297mm'} !important;
