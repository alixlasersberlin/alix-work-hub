...
export default function PortalLookup() {
  ...
  return (
    <BookingLayout hideLegalLinks narrow step={1} totalSteps={2}>
      ...
      <div className="text-center mb-2 dc-reveal">
      ...
      <div className="mt-6 rounded-2xl border border-primary/30 bg-primary/5 p-5 sm:p-6 space-y-3 text-sm text-muted-foreground">
