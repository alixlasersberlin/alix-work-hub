...
import { Loader2, Factory, Download, Search, Pencil, Camera, Calendar, User, Palette, Zap, Hash, ImageIcon, ArrowUpDown, HelpCircle, XCircle, Mail } from 'lucide-react';
...
const T: Record<Lang, Record<string, string>> = {
  de: {
    ...
    s_offen: 'offen', s_inBearbeitung: 'in Bearbeitung', s_fertig: 'fertig produziert', s_versendet: 'versendet',
  ...
  en: {
    ...
    s_offen: 'open', s_inBearbeitung: 'in progress', s_fertig: 'finished produced', s_versendet: 'shipped',
