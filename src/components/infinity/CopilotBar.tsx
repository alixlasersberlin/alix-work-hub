    ...
    <>
      ...
      {!open && (
        <button
          ...
          className="fixed bottom-5 right-5 z-[60] group flex items-center gap-2 rounded-full border border-amber-400/30 bg-black/70 backdrop-blur px-4 py-2.5 shadow-[0_10px_40px_-10px_rgba(245,158,11,0.5)] hover:border-amber-400/60 transition"
        >
      ...
      {/* Panel */}
      {open && (
        <div className="fixed bottom-5 right-5 z-[60] w-[min(420px,calc(100vw-2rem))] max-h-[min(640px,calc(100vh-2rem))] flex flex-col overflow-hidden rounded-2xl border border-amber-400/25 bg-black/85 backdrop-blur-xl shadow-[0_40px_80px_-20px_rgba(0,0,0,0.9)]">
