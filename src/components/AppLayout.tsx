...
const navItems: NavItem[] = [
  ...
  { path: '/auftragsstatus', label: 'AUFTRAGSSTATUS', icon: Activity, roles: ['Admin', 'Super Admin', 'Auftragsverwaltung', 'Order', 'Tourenplanung', 'Finance', 'Read Only Audit', 'SACHBEARBEITUNG'] },
