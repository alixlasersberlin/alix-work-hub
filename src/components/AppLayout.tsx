...
const navItems: NavItem[] = [
  ...
  {
    path: '/auftragsverwaltung/bestellungen', label: 'BESTELLWESEN', icon: ShoppingCart, roles: ['Admin', 'Super Admin', 'Auftragsverwaltung', 'Order', 'Tourenplanung', 'Finance', 'Österreich', 'Lieferant', 'FACTORY INVOICE', 'Bestellwesen'],
    children: [
      { path: '/detailsuche', label: 'Detailsuche', icon: SearchCheck, roles: ['Admin', 'Super Admin', 'Auftragsverwaltung', 'Order', 'Tourenplanung', 'Finance', 'Read Only Audit'] },
      { path: '/tickets', label: 'Ticketliste', icon: Ticket, roles: ['Admin', 'Super Admin', 'Kundenservice', 'Technik', 'Finance', 'Tourenplanung', 'Auftragsverwaltung', 'Order'] },
  ...
  },
  {
    ...
    children: [
      ...
      { path: '/garantie-kulanz', label: 'Garantie & Kulanz', icon: ShieldCheck, roles: ['Admin', 'Super Admin', 'Service', 'Serviceleitung', 'Technik', 'Kundenservice', 'Reparaturannahme', 'Finance', 'Tourenplanung'] },
  ...
  {
    path: '/aic', label: 'ALIX INTELLIGENCE', icon: Brain, roles: null,
    children: [
      { path: '/aic', label: 'Dashboard', icon: LayoutDashboard, roles: null },
      { path: '/aic/unternehmen', label: 'Unternehmen', icon: Building2, roles: null },
      { path: '/aic/forderungen', label: 'Forderungen', icon: AlertOctagon, roles: null },
      { path: '/aic/vertrieb', label: 'Vertrieb', icon: TrendingUp, roles: null },
      { path: '/aic/service', label: 'Service', icon: Wrench, roles: null },
      { path: '/aic/mitarbeiter', label: 'Mitarbeiter', icon: Users, roles: null },
      { path: '/aic/forecasts', label: 'Forecasts', icon: LineChart, roles: null },
      { path: '/aic/tasks', label: 'KI-Aufgaben', icon: ListChecks, roles: null },
      { path: '/aic/berichte', label: 'Berichte', icon: FileText, roles: null },
    ],
  },
  {
