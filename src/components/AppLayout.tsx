    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { path: '/auftraege/geliefert', label: 'Aufträge geliefert', icon: Truck, roles: ['Admin', 'Super Admin', 'Auftragsverwaltung', 'Order', 'Tourenplanung', 'Finance', 'Österreich', 'SACHBEARBEITUNG'] },
...

  {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          { path: '/finance/rechnungen', label: 'Rechnungen', icon: FileText, roles: ['Admin', 'Super Admin'] },
          { path: '/finance/vermietung', label: 'In Vermietung', icon: Repeat, roles: ['Admin', 'Super Admin'] },
