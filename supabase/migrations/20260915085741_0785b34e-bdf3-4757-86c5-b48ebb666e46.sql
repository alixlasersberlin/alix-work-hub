...
CREATE OR REPLACE FUNCTION public.gobd_restore_rid_ensure() RETURNS void
...
REVOKE EXECUTE ON FUNCTION public.gobd_restore_rid_ensure() FROM PUBLIC, anon, authenticated;
...
GRANT EXECUTE ON FUNCTION public.gobd_restore_rid_ensure() TO service_role;
