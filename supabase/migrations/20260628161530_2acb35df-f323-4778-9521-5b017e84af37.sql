CREATE OR REPLACE FUNCTION public.as_force_close_case(_case_id uuid, _reason text DEFAULT NULL::text)
...
GRANT EXECUTE ON FUNCTION public.as_force_close_case(uuid, text) TO service_role;