...
const BACKUP_TABLES = [
  ...
  "alixdocs_ai_jobs","alixdocs_approval_chains","alixdocs_approval_states",
  "alixdocs_audit_log","alixdocs_categories","alixdocs_document_links",
  "alixdocs_documents","alixdocs_match_feedback","alixdocs_matching_rules",
  "alixdocs_portal_shares","alixdocs_share_links","alixdocs_smart_config",
  "alixdocs_versions",
