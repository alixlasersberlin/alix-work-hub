...
Deno.serve(async (req) => {
  ...
  // 3) Orders (limit 1, auto-sync missing customers)
  const r3 = await invoke('scheduled-order-sync', { source_system: 'zoho_eu_2', days_back: 365, max_orders: 1, auto_sync_customers: true });
