...
- **Migrationsphase in `ph_settings.migration_phase`: aktuell Phase B (Parallelbetrieb, 31 Geräte importiert) — der bestehende COM→DE Sync bleibt aktiv und darf erst nach Validierung (Phase C) abgeschaltet werden. Quell-Endpoint: https://alix-legacy-reborn.lovable.app/api/public/product-hub/export (Secret DE_EXPORT_API_KEY).**
